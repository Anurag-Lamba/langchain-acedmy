...
supervisor_model = ChatGoogleGenerativeAI(
    model="models/gemini-2.5-pro",  # or "gemini-pro-vision" for images
    google_api_key=os.getenv("GOOGLE_API_KEY"),
)
# supervisor_model=ChatGroq(groq_api_key=os.getenv('GROQ_API_KEY'),model='meta-llama/llama-guard-4-12b')
# supervisor_model=ChatNVIDIA(NVIDIA_API_KEY=os.getenv('NVIDIA_API_KEY'),model='meta/llama-3.3-70b-instruct')
